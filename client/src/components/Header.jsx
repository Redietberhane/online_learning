...
function Header({ logoutUpdate }) {
    ...
    //     setModalsArray.map((modal) => modal(false));
    // };

    // const toggleVerify = () => {
    //     setVerifyModal(!verifyModal);
    //     !verifyModal ? disableScroll() : enableScroll();
    // };

    const openVerifySignup = () => {
        setVerifyModal(true);
        closeOthersExcept(signupModal);
        setSignupModal(true);
    };
        ...
        <>
            {signinModal && (
                <LoginModal
                    ...
                    openVerifySignup={openVerifySignup}
                            ...
                            localStorage.getItem("user_id") === null ? (
                                <>
                                    <div
                                        ...
                                        className="button-component h-12">
                                        Log in{" "}
                                    </div>
                                    <div
